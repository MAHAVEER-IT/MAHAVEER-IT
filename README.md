...
<p align="center">
  <details>
    <summary><b>🌱 Sow And Grow - Flutter Mobile Application</b></summary>
    <br>
    <p>
      An innovative Flutter mobile application designed to help rural farmers monitor crop diseases, communicate with veterinarians, and receive vaccination alerts.
      <br><br>
      <b>Features:</b>
      <ul>
        <li>🤖 AI-driven image recognition for plant diseases</li>
        <li>🗣️ Voice assistance & local language support</li>
        <li>🔔 Vaccination alerts for livestock</li>
        <li>👨‍⚕️ Direct communication with veterinarians</li>
      </ul>
      <b>Tech:</b> Flutter, Firebase, TensorFlow Lite, Google Maps API
      <br>
      <b>Last Updated:</b> July 12, 2025
    </p>
  </details>
</p>
...
<p align="center">
  <details>
    <summary><b>📝 AI-NoteMate - MERN Stack Application</b></summary>
    <br>
    <p>
      A MERN stack web app designed for productivity, featuring intelligent note-taking, movable sticky notes, and AI-generated schedules.
      <br><br>
      <b>Features:</b>
      <ul>
        <li>🧠 Intelligent note-taking system</li>
        <li>🎯 Movable sticky notes & task board</li>
        <li>🎙️ Speech-to-text capabilities</li>
        <li>⏰ AI-generated schedules & personalized reminders</li>
      </ul>
      <b>Tech:</b> MongoDB, Express.js, React.js, Node.js, OpenAI API
      <br>
      <b>Last Updated:</b> July 12, 2025
    </p>
  </details>
